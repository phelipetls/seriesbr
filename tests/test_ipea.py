    ...
    [
        ...
        (
            {"start": "2019"},
            {
                "url": BASE_URL,
                "params": {
                    "$filter": "VALDATA ge 2019-01-01T00:00:00Z",
                },
            },
        ),
        (
            {"start": "2019-11"},
            {
                "url": BASE_URL,
                "params": {
                    "$filter": "VALDATA ge 2019-11-01T00:00:00Z",
                },
            },
        ),
        (
        ...
        (
            {"end": "2019"},
            {
                "url": BASE_URL,
                "params": {
                    "$filter": "VALDATA le 2019-12-31T00:00:00Z",
                },
            },
        ),
        (
            {"end": "2019-11"},
            {
                "url": BASE_URL,
                "params": {
                    "$filter": "VALDATA le 2019-11-30T00:00:00Z",
                },
            },
        ),
        (
