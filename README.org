...
See our documentation at [[https://seriesbr.readthedocs.io/en/latest][readthedocs]].
...
For a quick demo, check out the function below, which allows you to get
values from both IPEA and BCB in one call.
